...
metadata:
  short-description: Extract TikZ diagrams from Beamer source, compile to PDF, convert to SVG with 0-based indexing. Use when updating TikZ diagrams for Quarto slides.
---

**Arguments:** "[LectureN, e.g., Lecture2]"
