...
metadata:
  short-description: Create a new Beamer lecture from papers, existing slides, R scripts, and other materials. Guides the content creation process with notation consistency, pedagogical patterns, and collaborative iteration.
---

**Arguments:** "[Topic name, e.g., 'Synthetic Control' or 'Regression Discontinuity']"
