...
metadata:
  short-description: Stage, commit, create PR, and merge to main. Use for the standard commit-PR-merge cycle.
---
...
Do NOT stage `.codex/config.local.toml` or any files containing secrets.
...
- Exclude `config.local.toml` and sensitive files from staging
