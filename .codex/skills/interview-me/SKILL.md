...
metadata:
  short-description: Interactive interview to formalize a research idea into a structured specification with hypotheses and empirical strategy
---

**Arguments:** "[brief topic or 'start fresh']"
