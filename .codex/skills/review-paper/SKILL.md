...
metadata:
  short-description: Comprehensive manuscript review covering argument structure, econometric specification, citation completeness, and potential referee objections
---

**Arguments:** "[paper filename in master_supporting_docs/ or path to .tex/.pdf]"
